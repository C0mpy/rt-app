{application,hex,
             [{description,"hex"},
              {modules,['Elixir.Hex','Elixir.Hex.API','Elixir.Hex.API.Key',
                        ...
                        'Elixir.Mix.Tasks.Hex.User',hex_pb_package,
                        hex_pb_signed,safe_erl_term]},
              {registered,[]},
              {vsn,"0.16.0"},
