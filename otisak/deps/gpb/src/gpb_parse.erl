...
-file("src/gpb_parse.erl", 5592).
-compile({inline,yeccpars2_186_/1}).
-file("src/gpb_parse.yrl", 333).
...
-file("src/gpb_parse.erl", 5676).
-compile({inline,yeccpars2_204_/1}).
-file("src/gpb_parse.yrl", 339).
...
-file("src/gpb_parse.erl", 5912).
-compile({inline,yeccpars2_251_/1}).
-file("src/gpb_parse.yrl", 280).
